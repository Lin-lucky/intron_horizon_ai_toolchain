...
#ifndef _METHOD_PTQ_YOLO3_DARKNET_POST_PROCESS_METHOD_H_
#define _METHOD_PTQ_YOLO3_DARKNET_POST_PROCESS_METHOD_H_
 ...
 */
class PTQYolo3DarknetPostProcessMethod : public xstream::SimpleMethod {
 public:
  /**
  ...
  ~PTQYolo3DarknetPostProcessMethod() override;
