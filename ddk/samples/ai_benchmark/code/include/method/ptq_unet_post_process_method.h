...
#ifndef _METHOD_PTQ_UNET_POST_PROCESS_METHOD_H_
#define _METHOD_PTQ_UNET_POST_PROCESS_METHOD_H_
 ...
 */
class PTQUnetPostProcessMethod : public xstream::SimpleMethod {
 public:
  /**
  ...
  ~PTQUnetPostProcessMethod() override;
...
#endif  // _METHOD_PTQ_UNET_POST_PROCESS_METHOD_H_
