...
#ifndef _METHOD_PTQ_YOLO3_VARG_DARKNET_POST_PROCESS_METHOD_H_
#define _METHOD_PTQ_YOLO3_VARG_DARKNET_POST_PROCESS_METHOD_H_
 ...
 */
struct PTQYolo3VargDarknetConfig {
...
extern PTQYolo3VargDarknetConfig default_ptq_yolo3_varg_darknet_config;
/**
 * Method for post processing
 */
class PTQYolo3VargDarknetPostProcessMethod : public xstream::SimpleMethod {
 public:
  /**
  ...
  ~PTQYolo3VargDarknetPostProcessMethod() override;
 ...
 private:
  ...
  void PostProcessNHWC(hbDNNTensor *tensor,
                       ImageTensor *frame,
                       int layer,
                       std::vector<Detection> &dets);

  void PostProcessNCHW(hbDNNTensor *tensor,
                       ImageTensor *frame,
                       int layer,
                       std::vector<Detection> &dets);
 ...
 private:
  ...
  PTQYolo3VargDarknetConfig yolo3_config_ =
      default_ptq_yolo3_varg_darknet_config;
...
#endif  // _METHOD_PTQ_YOLO3_POST_PROCESS_METHOD_H_
