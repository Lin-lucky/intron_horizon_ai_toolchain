...
#ifndef _METHOD_PTQ_CLASSFICATION_POST_PROCESS_METHOD_H_
#define _METHOD_PTQ_CLASSFICATION_POST_PROCESS_METHOD_H_
 ...
 */
class PTQClassficationPostProcessMethod : public xstream::SimpleMethod {
 public:
  /**
  ...
  ~PTQClassficationPostProcessMethod() override;

 private:
  int PostProcess(hbDNNTensor *tensors,
...
#endif  // _METHOD_PTQ_CLASSFICATION_POST_PROCESS_METHOD_H_
