 ...
 */
class PTQFcosPostProcessMethod : public xstream::SimpleMethod {
 public:
  /**
  ...
  ~PTQFcosPostProcessMethod() override;

 private:
  void GetBboxAndScoresNCHW(std::vector<hbDNNTensor> &tensors,
                            ImageTensor *image_tensor,
                            std::vector<Detection> &dets);
  void GetBboxAndScoresNHWC(std::vector<hbDNNTensor> &tensors,
                            ImageTensor *image_tensor,
                            std::vector<Detection> &dets);
