...
quanti_model_file="./model_output/mobilenetv1_224x224_bgr_planar_quantized_model.onnx"
quanti_input_layout="NHWC"

#for original float model inference
original_model_file="./model_output/mobilenetv1_224x224_bgr_planar_original_float_model.onnx"
