...
quanti_model_file="./model_output/mobilenet_multi_224x224_gray_quantized_model.onnx"
quanti_input_layout="NHWC"

#for original float model inference
original_model_file="./model_output/mobilenet_multi_224x224_gray_original_float_model.onnx"
...
infer_image="../../../01_common/data/imagenet/val/ILSVRC2012_val_00000796.JPEG"
