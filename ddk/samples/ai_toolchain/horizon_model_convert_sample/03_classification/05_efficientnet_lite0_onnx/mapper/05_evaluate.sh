...
quanti_model_file="./model_output/efficientnet_lite0_224x224_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

original_model_file="./model_output/efficientnet_lite0_224x224_nv12_original_float_model.onnx"
