...
def calibration_transformers():
    """
    step：
        1、crop size 280 * 280 from padded center
        2、resize to 280 * 280
        3、Scale from 0 ~ 1 to 0 ~ 255
    """
    transformers = [
        PaddedCenterCropTransformer(image_size=280, crop_pad=32),
        # Cubic interpolation resize
        ResizeTransformer(target_size=(280, 280), mode='skimage', method=3),
...
def infer_transformers(input_layout="NHWC"):
    ...
    transformers = [
        ...
        NV12ToYUV444Transformer((280, 280),
