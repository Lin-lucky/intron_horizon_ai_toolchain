...
quanti_model_file="./model_output/efficientnet_lite3_280x280_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

original_model_file="./model_output/efficientnet_lite3_280x280_nv12_original_float_model.onnx"
