...
quanti_model_file="./model_output/googlenet_224x224_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

#for original float model inference
original_model_file="./model_output/googlenet_224x224_nv12_original_float_model.onnx"
