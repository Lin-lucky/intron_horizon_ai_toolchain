...
quanti_model_file="./model_output/efficientnet_lite1_240x240_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

original_model_file="./model_output/efficientnet_lite1_240x240_nv12_original_float_model.onnx"
