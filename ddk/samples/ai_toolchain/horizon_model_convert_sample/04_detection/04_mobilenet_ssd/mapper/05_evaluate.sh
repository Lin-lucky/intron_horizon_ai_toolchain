...
quanti_model_file="./model_output/mobilenet_ssd_300x300_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

original_model_file="./model_output/mobilenet_ssd_300x300_nv12_original_float_model.onnx"
...
image_path="../../../01_common/data/VOCdevkit/VOC2012/JPEGImages"
anno_path="../../../01_common/data/VOCdevkit/VOC2012/"
if [ -z $2 ]; then 
  val_txt_path="../../../01_common/data/VOCdevkit/VOC2012/ImageSets/Main/val.txt"
else
  val_txt_path="../../../01_common/test_data/voc_val_piece.txt"
fi
