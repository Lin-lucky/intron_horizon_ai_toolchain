...
quanti_model_file="./model_output/centernet_512x512_nv12_quantized_model.onnx"
quanti_input_layout="NHWC"

original_model_file="./model_output/centernet_512x512_nv12_original_float_model.onnx"
