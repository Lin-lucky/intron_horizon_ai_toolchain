...
def calibration_transformers():
    """
    step：
        1、pad resize to 512 * 512
        2、NHWC to NCHW
        3、bgr to yuv444
    """
    transformers = [
        PadResizeTransformer((512, 512), pad_position='bottom_right'),
        HWC2CHWTransformer(),
...
def infer_transformers(input_shape, input_layout="NHWC"):
    ...
    """
    transformers = [
        PadTransformer(size_divisor=512, target_size=512),
        RGB2NV12Transformer(data_format="HWC", cvt_mode="opencv"),
        NV12ToYUV444Transformer(target_size=(512, 512),
