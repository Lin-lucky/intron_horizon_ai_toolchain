 ...
 * @date      2018.12.07
 */
#ifndef INCLUDE_IMAGEUTILS_IMAGEUTILS_H_
#define INCLUDE_IMAGEUTILS_IMAGEUTILS_H_
#include <stdint.h>
...
#define HOBOTXSTREAM_IMAGE_TOOLS_VERSION 1.0.0
...
#endif  // INCLUDE_IMAGEUTILS_IMAGEUTILS_H_
