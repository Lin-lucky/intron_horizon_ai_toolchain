 ...
 * -------------------------------------------
 */
#ifndef XPROTO_DISPLAY_PLUGIN_INCLUDE_ATTRIBUTE_CONVERT_
#define XPROTO_DISPLAY_PLUGIN_INCLUDE_ATTRIBUTE_CONVERT_
...
namespace xproto {
class AttributeConvert : public horizon::vision::CSingleton<AttributeConvert> {
 public:
  AttributeConvert() {}
  ~AttributeConvert() {
    if (has_init_) {
...
#endif  // XPROTO_UVC_DISPLAY_PLUGIN_INCLUDE_ATTRIBUTE_CONVERT_
