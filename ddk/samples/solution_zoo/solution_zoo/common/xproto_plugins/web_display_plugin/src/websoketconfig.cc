...
// websocket config
WebDisplayConfig::WebDisplayConfig(const std::string &path) : path_(path) {
  auth_mode_ = 0;
...
bool WebDisplayConfig::LoadConfig() {
...
std::string WebDisplayConfig::GetValue(const std::string &key) {
...
Json::Value WebDisplayConfig::GetJson() const { return this->json_; }

bool WebDisplayConfig::CheckConfig() {
