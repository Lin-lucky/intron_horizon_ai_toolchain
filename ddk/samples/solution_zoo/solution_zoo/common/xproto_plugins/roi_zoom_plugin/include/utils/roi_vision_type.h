...
#ifndef INCLUDE_UTILS_ROI_VISION_TYPE_H_
#define INCLUDE_UTILS_ROI_VISION_TYPE_H_
#ifdef __cplusplus
extern "C" {
#endif
...
typedef enum HorizonVisionPixelFormat_ {
  /// \~Chinese 普通图片文件的二进制流，默认BGR, 需要与二进制流文件长度一起配套使用   // NOLINT
...
#endif
#endif  // INCLUDE_UTILS_ROI_VISION_TYPE_H_
