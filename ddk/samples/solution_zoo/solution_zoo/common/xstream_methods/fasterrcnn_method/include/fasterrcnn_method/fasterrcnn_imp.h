...
class FasterRCNNImp {
 ...
 private:
  ...
  void GetRppRects(std::map<std::string, std::vector<xstream::BBox>> &boxes,
                   int index,
  ...
  void GetReid(std::vector<xstream::FloatFeature> &reids, void *output,
               const std::vector<BBox> &body_boxes);
  // get face lmk
  void GetLMKS(std::vector<xstream::Landmarks> &landmarks,
      void* output,
  ...
  void GetPlateColor(std::vector<xstream::Attribute_<int>> *plate_color,
                     void* output,
                     const std::vector<xstream::BBox> &plate_box);

  // get vehicle plate row.
  void GetPlateRow(std::vector<xstream::Attribute_<int>> *plates_row,
                   void* output,
