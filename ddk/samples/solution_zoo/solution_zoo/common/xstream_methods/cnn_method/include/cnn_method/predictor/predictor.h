...
class Predictor {
 ...
 protected:
  int RunModelWithBBox(xstream::PyramidImageFrame &pym_image, BPU_BBOX *box,
                       int box_num, int *resizable_cnt);
...
//  float aspect_ratio_;
 ...
 private:
  int FilterRoi(xstream::BBox *src, xstream::BBox *dst, int src_w,
