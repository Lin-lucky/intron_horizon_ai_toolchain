...
INCLUDE_SNAPSHOT_METHOD_STRATEGY_FIRST_NUM_BEST_H_
...
class FirstNumBest : public SnapShot {
 ...
 private:
  ...
  int UpdateState(const ImageFramePtr &frame, uint32_t &crop_count,
                  const xstream::BBoxPtr &pbbox, const float &select_score,
...
#endif  // COMMON_XSTREAM_METHODS_SNAPSHOT_METHOD_INCLUDE_SNAPSHOT_METHOD_STRATEGY_FIRST_NUM_BEST_H_
