...
struct FaceSnapFilterParam : public xstream::InputParam {
  explicit FaceSnapFilterParam(const std::string &content = "")
    ...
    unique_name_ = "FaceSnapFilterMethod";
    light_mode_ = "NormalLight";
  ...
  virtual int UpdateParameter(const std::string &content) {
    ...
    try {
      ...
      SetFilterParam();
      SetFilterErrCode();
      auto light_mode = config_jv["light_mode"];
      if (!light_mode.isNull()) {
        light_mode_ = light_mode.asString();
      }
      ...
      // update 5 lmk points threshold
      Json::Value jv = config_jv["lmk_thr"];
      if (!jv.isNull()) {
        int lmk_thr_num = jv.size();
        assert(lmk_thr_num == 5);
        for (int i = 0; i < lmk_thr_num; ++i) {
          lmk_thr[i] = jv[i].asFloat();
        }
        config_jv_all_["lmk_thr"] = jv;
      }
  ...
  void SetOccludeErrCode() {
    ...
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, left_eye_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, right_eye_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, left_brow_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, right_brow_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, forehead_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, left_cheek_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, right_cheek_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, nose_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, mouth_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, jaw_occluded_dark_thr);
  }
  ...
  void SetFilterErrCode() {
    ...
    SET_FACE_SNAP_FILTER_ERROR_CODE(desp, quality_dark_thr);
    SetOccludeErrCode();
  }
  ...
  void SetOccludeParam() {
    ...
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, left_eye_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, right_eye_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, left_brow_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, right_brow_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, forehead_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, left_cheek_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, right_cheek_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, nose_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, mouth_occluded_dark_thr);
    SET_FACE_SNAP_FILTER_METHOD_PARAM(
        config_jv, Double, jaw_occluded_dark_thr);
  }
  ...
  void SetFilterParam() {
    ...
    SET_FACE_SNAP_FILTER_METHOD_PARAM(config_jv, Double, quality_dark_thr);
  ...
  float quality_dark_thr = 0.0;  // the threshold of snap quality in dark light
  float lmk_thr[5] = {2.0, 2.0, 2.0, 2.0,
                      2.0};           // the threshold of snap 5 lmk points
  ...
  float left_eye_occluded_dark_thr = 0.75;
  float right_eye_occluded_dark_thr = 0.75;
  float left_brow_occluded_dark_thr = 0.7;
  float right_brow_occluded_dark_thr = 0.7;
  float forehead_occluded_dark_thr = 1.0;
  float left_cheek_occluded_dark_thr = 0.65;
  float right_cheek_occluded_dark_thr = 0.65;
  float nose_occluded_dark_thr = 0.7;
  float mouth_occluded_dark_thr = 0.7;
  float jaw_occluded_dark_thr = 0.7;
  ...
  int quality_dark_thr_err_code = -1;
  int left_eye_occluded_dark_thr_err_code = -1;
  int right_eye_occluded_dark_thr_err_code = -1;
  int left_brow_occluded_dark_thr_err_code = -1;
  int right_brow_occluded_dark_thr_err_code = -1;
  int forehead_occluded_dark_thr_err_code = -1;
  int left_cheek_occluded_dark_thr_err_code = -1;
  int right_cheek_occluded_dark_thr_err_code = -1;
  int nose_occluded_dark_thr_err_code = -1;
  int mouth_occluded_dark_thr_err_code = -1;
  int jaw_occluded_dark_thr_err_code = -1;
