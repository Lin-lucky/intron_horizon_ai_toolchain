...
TEST(DATA_TYPE, BBOX) {
  ...
  EXPECT_FLOAT_EQ(bbox1.x1_, 23);
  EXPECT_FLOAT_EQ(bbox1.y1_, 45);
  EXPECT_FLOAT_EQ(bbox1.x2_, 89);
  EXPECT_FLOAT_EQ(bbox1.y2_, 90);

  BBox bbox2(bbox_list[0], bbox_list[1], bbox_list[2], bbox_list[3]);
  EXPECT_FLOAT_EQ(bbox2.x1_, 23);
  EXPECT_FLOAT_EQ(bbox2.y1_, 45);
  EXPECT_FLOAT_EQ(bbox2.x2_, 89);
  EXPECT_FLOAT_EQ(bbox2.y2_, 90);
}
