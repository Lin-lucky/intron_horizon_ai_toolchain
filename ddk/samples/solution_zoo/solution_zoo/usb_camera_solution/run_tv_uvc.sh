...
solution_cfg_func() {
  resolution=$1
  cp -rf usb_camera/configs/box_filter_config_${resolution}M.json  usb_camera/configs/box_filter_config.json
  cp -rf usb_camera/configs/infer_multitask_with_hand_960x544_${resolution}M.json  usb_camera/configs/infer_multitask_with_hand_960x544.json
}
...
choose_solution_func() {
  ...
  sleep 3
  chmod +x ./usb_camera/usb_camera
  ./usb_camera/usb_camera $vio_cfg_file ./usb_camera/configs/dance_solution_multitask_960x544.json ./configs/display_config.json -${log_level} normal
}
