...
solution_cfg_func() {
  resolution=$1
  cp -rf usb_camera/configs/infer_multitask_config_${resolution}M.json  usb_camera/configs/infer_multitask_config.json
}
...
choose_solution_func() {
  ...
  sleep 3
#  ./usb_camera/usb_camera $vio_cfg_file ./usb_camera/configs/body_solution.json ./configs/visualplugin_body.json -${log_level} normal
   chmod +x ./usb_camera/usb_camera
  ./usb_camera/usb_camera $vio_cfg_file ./usb_camera/configs/body_solution.json ./configs/display_config.json -${log_level} normal
}
