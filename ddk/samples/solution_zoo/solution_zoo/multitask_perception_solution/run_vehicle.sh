...
solution_cfg_func() {
  resolution=$1
  cp -rf multitask_perception/configs/config_match_${resolution}M.json  multitask_perception/configs/config_match.json
  cp -rf multitask_perception/configs/infer_vehicle_multitask_${resolution}M.json  multitask_perception/configs/infer_vehicle_multitask.json
}
...
choose_solution_func() {
  ...
  sleep 3
  ./multitask_perception/multitask_perception $vio_cfg_file ./multitask_perception/configs/vehicle_solution.json ./configs/display_config.json -${log_level} normal
}
