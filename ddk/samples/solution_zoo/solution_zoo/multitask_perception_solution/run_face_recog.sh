...
solution_cfg_func() {
  resolution=$1
  cp -rf multitask_perception/configs/filter_config_${resolution}M.json multitask_perception/configs/filter_config.json
  cp -rf multitask_perception/configs/infer_face_pose_lmk_${resolution}M.json multitask_perception/configs/infer_face_pose_lmk.json
}
...
choose_solution_func() {
  ...
  ./multitask_perception/multitask_perception $vio_cfg_file ./multitask_perception/configs/face_recog_solution.json ./configs/display_config.json -${log_level} normal
}
