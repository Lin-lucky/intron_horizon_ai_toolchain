...
solution_cfg_func() {
  resolution=$1
  cp -rf yolov3_mobilenetv2_example/configs/infer_yolov3_config_${resolution}M.json  yolov3_mobilenetv2_example/configs/infer_yolov3_config.json
}
...
choose_solution_func() {
  ...
  sleep 3
  chmod +x ./yolov3_mobilenetv2_example/yolov3_mobilenetv2_example
  ./yolov3_mobilenetv2_example/yolov3_mobilenetv2_example $vio_cfg_file ./yolov3_mobilenetv2_example/configs/solution_yolov3.json ./configs/visualplugin_body.json -${log_level} normal
}
