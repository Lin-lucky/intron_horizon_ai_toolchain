...
#ifndef XPROTO_SRC_INCLUDE_XPROTO_UTILS_SINGLETON_H_
#define XPROTO_SRC_INCLUDE_XPROTO_UTILS_SINGLETON_H_
#include <assert.h>
namespace xproto {
template <typename T>
class CSingleton {
...
#endif  // XPROTO_SRC_INCLUDE_XPROTO_UTILS_SINGLETON_H_
